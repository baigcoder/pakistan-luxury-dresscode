...
export const PRODUCTS: ProductItem[] = [
    ...
    gallery: [
      {
        ...
        alt: "Full silhouette of Sculptural Raw Silk Trench",
    ...
    gallery: [
      {
        ...
        alt: "Extreme macro of Ajrak block print",
  ...
  },
  {
    ...
    gallery: [
      {
        url: "/images/lahore-courtyard.jpg",
        alt: "Full view in Lahore courtyard",
        caption: "Wide-leg trouser and unconstructed jacket in raw linen",
      },
      {
        url: "/images/hero-couture.jpg",
        alt: "Studio detail",
